...
const mostrarLivros = (listaLivros) => {
  ...
  //passa por cada elemento da lista de livros e acrescenta no tbody uma linha (com coluna) correspondente ao livro
  listaLivros.forEarch((livro) => {
...
//FUNÇÂO QUE CARREGA OS DADOS NA TELA
const carregarDados = async () => {
  ...
  //chamada à função que redenriza os livros na página HTML passando a lista de livros como parâmetro
